function carregaEdicaoReagente(id) {
	$.ajax({
		...
		$("#indicacaoRevalidacao-model").html("<strong>Indicação de Uso Após Revalidação: </strong>" + reagent.indicacaoRevalidacao);
		...
		$("#compostoDescarte-model").html("<strong>Composto Para o Descarte: </strong>" + reagent.compostoDescarte);
